...
const ChangePassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let reqOptions = {
      url: "https://eternal-backend.onrender.com/auth/password",
      method: "POST",
      headers: headersList,
      data: bodyContent,
    }
          ...
          <form onSubmit={handleSubmit} class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
            <div class="flex flex-wrap -mx-3 mb-6">
              ...
              <div class="w-full md:w-full px-3 mt-4">
                <button type='submit' class="appearance-none block w-full bg-blue-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:outline-none focus:bg-white focus:border-gray-500">Change Password</button>
              </div>
            </div>
          </form>
        </div>
